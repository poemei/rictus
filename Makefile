...
OBJECTS := $(BUILD_DIR)/main.o $(BUILD_DIR)/rictus.o $(BUILD_DIR)/irc.o $(BUILD_DIR)/artifact.o $(BUILD_DIR)/config.o $(BUILD_DIR)/irc_message.o $(BUILD_DIR)/event.o $(BUILD_DIR)/dispatch.o $(BUILD_DIR)/command.o $(BUILD_DIR)/module_inventory.o $(BUILD_DIR)/module_state.o $(BUILD_DIR)/module_lifecycle.o $(BUILD_DIR)/module_loader_linux.o $(BUILD_DIR)/module_discovery_linux.o $(BUILD_DIR)/module_watch_linux.o
ABI_DIR := ../ABI
ABI_OBJECTS := $(BUILD_DIR)/abi_module.o $(BUILD_DIR)/abi_module_registry.o
LDLIBS := -lssl -lcrypto
CORE_LDLIBS := -ldl -lcrypto -pthread
...
$(BUILD_DIR)/module_watch_linux.o: platforms/linux/rictus_module_watch_linux.c
	@mkdir -p $(BUILD_DIR)
	$(CC) $(CPPFLAGS) $(CFLAGS) -pthread -c $< -o $@
